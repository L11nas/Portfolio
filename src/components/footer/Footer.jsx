...
const Footer = () => {
  ...
  const translations = {
    LT: {
      ...
      scrollToTop: 'Grįžti į viršų',
      scrollToTopAriaLabel: 'Grįžti į puslapio viršų',
    },
    EN: {
      title: 'LinasWebDev',
      ...
      scrollToTopAriaLabel: 'Scroll to top of the page',
    },
  };
  ...
  return (
    <>
      {/* Fiksuotas grįžimo į viršų mygtukas */}
