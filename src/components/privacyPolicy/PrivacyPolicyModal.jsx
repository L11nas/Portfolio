    ...
    >
      <Box sx={modalStyle}>
        <Typography
          ...
          variant='h6'
          component='h2'
          sx={{ color: 'text.primary' }} // Balta spalva tamsiam režimui
        ></Typography>
        ...
        <Typography variant='body2' sx={{ mt: 2 }}>
          <p>
            ...
            <br />
            Jūsų pateikti duomenys naudojami tik tam, kad galėtume atsakyti į
            jūsų užklausą. Mes nenaudojame jūsų duomenų jokiais kitais tikslais.
          </p>
        </Typography>
        <Typography variant='body2' sx={{ mt: 2 }}>
          <p>
            ...
            <br />
            Jūsų pateikti duomenys saugomi tik tol, kol atsakome į jūsų
            užklausą. Po to jie pašalinami.
          </p>
        </Typography>
        <Typography variant='body2' sx={{ mt: 2 }}>
          <p>
            ...
            <strong>Email.js</strong>. Ši paslauga užtikrina žinučių siuntimą
            el. paštu. Naudojant šią paslaugą, jūsų duomenys yra tvarkomi pagal{' '}
            <strong>Email.js</strong> privatumo politiką. Ateityje planuojama
            integruoti <strong>SEO įrankius</strong>, kurie taip pat gali
            naudoti tam tikrus duomenis analitikai.
          </p>
        </Typography>
        <Typography variant='body2' sx={{ mt: 2 }}>
          <p>
            ...
            <br />
            Šiuo metu mes nenaudojame slapukų ar kitų stebėjimo technologijų.
            Jei ateityje tai bus pakeista, apie tai informuosime jus iš anksto.
          </p>
        </Typography>
        <Typography variant='body2' sx={{ mt: 2 }}>
          <p>
        ...
        <Typography variant='body2' sx={{ mt: 2 }}>
          <p>
            ...
            <br />
            Jeigu turite klausimų apie savo duomenų apsaugą ar norite
            pasinaudoti savo teisėmis, susisiekite el. paštu:{' '}
